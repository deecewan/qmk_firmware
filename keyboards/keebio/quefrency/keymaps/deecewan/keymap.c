...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,   KC_F10,    KC_LCTL, KC_LGUI, KC_LALT, MO(_FN1), KC_SPC,           KC_NO,   KC_SPC,  KC_RALT, KC_RCTL, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______, _______,   RGB_TOG, RGB_MOD, _______, KC_UP,    QK_BOOT, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______,
    _______, _______,   _______, _______, KC_LEFT, KC_DOWN,  KC_RGHT, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    // disabled, for now. the encs are borked
    return false;
}
